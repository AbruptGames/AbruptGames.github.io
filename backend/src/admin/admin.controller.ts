...
export class AdminController {
    ...
    async testStuff() {
        ...
        // await this.emailsService.createContact("celianhaydont@gmail.com", "french", true);
        await this.emailsService.setTemplate("test", {
            Subject: "Salut",
            Html: "Le message"
        });
        await this.emailsService.sendEmail("test", "game_key-french");
    }
