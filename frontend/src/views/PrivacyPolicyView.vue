<template>
    <div class="main">
        ...
        <p><b>Last updated August 06, 2023</b></p>

        <p>
            This privacy notice for AbruptGames ("<b>Company</b>," "<b>we</b>," "<b>us</b>," or "<b>our</b>"), describes how
            and why we might collect, store, use, and/or share ("<b>process</b>") your information when you use our services
            ("<b>Services</b>"), such as when you:<br>
        <ul>
            <li>Visit our website at <a href="/" target="_blank">www.abruptgames.fr</a>, or any website of ours
        ...
        concerns, please contact us at <b>abrupt.game@gmail.com</b>.<br>
        </p>

        <h2>SUMMARY OF KEY POINTS</h2>

        <p>
            <b>What personal information do we process?</b> When you visit, use, or navigate our Services, we may process
            personal information depending on how you interact with AbruptGames and the Services, the choices you make, and
            the products and features you use.<br>
            <br>
            ...
            situations and with specific third parties.<br>
            <br>
            ...
            steal, or modify your information.<br>
            <br>
            ...
            How do you exercise your rights? The easiest way to exercise your rights is by visiting <a
                href="unsubscribe" target="_blank">www.abruptgames.fr/unsubscribe</a>, or by contacting us. We
            will consider and act upon any request in accordance with applicable data protection laws.<br>
            <br>
            Want to learn more about what AbruptGames does with any information we collect? Review the privacy notice in
            full.<br>
        </p>
        ...
        <p>
            ...
            8. CONTROLS FOR DO-NOT-TRACK FEATURES<br>
            9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?<br>
            10. DO VIRGINIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?<br>
        ...
        <p>
            ...
            any changes to such personal information.<br>
        </p>
        ...
        <p>
            ...
            characteristics — is collected automatically when you visit our Services.<br>
            <br>
            ...
            operation of our Services, and for our internal analytics and reporting purposes.<br>
            <br>
            ...
            use to access the Services. Depending on the device used, this device data may include information such as your
            ...
            you choose to opt out, you may not be able to use certain aspects of the Services.<br>
        </p>
        ...
        <p>
            ...
            protect an individual's vital interest, such as to prevent harm.<br>
        </p>
        ...
        <p>
            ...
            fulfill our legitimate business interests.<br>
            <br>
            ...
            legal rights, or disclose your information as evidence in litigation in which we are involved.<br>
            ...
            your consent, including, for example:<br>
        ...
        <p>
            ...
            longer than the period of time in which users have an account with us.<br>
            <br>
        ...
        <p>
            ...
            terminate your account at any time.<br>
            <br>
            ...
            details provided in the section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below.<br>
            <br>
            ...
            the section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below.<br>
            <br>
            ...
            lawful processing grounds other than consent.<br>
            <br>
            ...
            using the details provided in the section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below. You will then be
            ...
            service requests, or for other non-marketing purposes.<br>
            <br>
            ...
            assist with any investigations, enforce our legal terms and/or comply with applicable legal requirements.<br>
            <br>
            If you have questions or comments about your privacy rights, you may email us at abrupt.game@gmail.com.<br>
        </p>
        ...
        <p>
            ...
            from all our systems (e.g., backups, etc.).<br>
            <br>
            ...
            temporary or transitory purpose<br>
            <br>
            ...
            identifier, online identifier, Internet Protocol address, email address, and account name<br>
            2. Geolocation data<br>
            Device location<br>
            <br>
            We will use and retain the collected personal information as needed to provide the Services or as long as the
            user has an account with us<br>
            We may also collect other personal information outside of these categories through instances where you interact
            with us in person, online, or by phone or mail in the context of:<br>
            ...
            <br>
            You may contact us by email at abrupt.game@gmail.com, or by referring to the contact details at the bottom of
            this document.<br>
            <br>
            If you are using an authorized agent to exercise your right to opt out we may deny a request if the authorized
            agent does not submit proof that they have been validly authorized to act on your behalf.<br>
            <br>
            ...
            behalf, following the same strict privacy protection obligations mandated by the CCPA.<br>
            <br>
            ...
            information.<br>
            <br>
            AbruptGames has not disclosed, sold, or shared any personal information to third parties for a business or
            commercial purpose in the preceding twelve (12) months. AbruptGames will not sell or share personal information
            in the future belonging to website visitors, users, and other consumers.<br>
            <br>
            ...
            in accordance with the CCPA.<br>
            ...
            fifteen (15) days from the date of the request submission.<br>
            To exercise these rights, you can contact us by email at abrupt.game@gmail.com, or by referring to the contact
        ...
        <p>
            In Short: Yes, if you are a resident of Virginia, you may be granted specific rights regarding access to and use
            ...
            household context. It does not include a natural person acting in a commercial or employment context.<br>
            <br>
            "Personal data" means any information that is linked or reasonably linkable to an identified or identifiable
            natural person. "Personal data" does not include de-identified data or publicly available information.<br>
            <br>
            ...
            personal data.<br>
            <br>
            The information we collect, use, and disclose about you will vary depending on how you interact with AbruptGames
            and our Services. To find out more, please visit the following links:<br>
            ...
            ("profiling")<br>
            AbruptGames has not sold any personal data to third parties for business or commercial purposes. AbruptGames
            will not sell personal data in the future belonging to website visitors, users, and other consumers.<br>
            <br>
            Exercise your rights provided under the Virginia CDPA<br>
            <br>
            More information about our data collection and sharing practices can be found in this privacy notice.<br>
            <br>
            You may contact us by email at abrupt.game@gmail.com or by
            referring to the contact details at the bottom of this document.<br>
            <br>
            If you are using an authorized agent to exercise your rights, we may deny a request if the authorized agent does
            not submit proof that they have been validly authorized to act on your behalf.<br>
            <br>
            Verification process<br>
            <br>
            ...
            verify your identity before processing your request.<br>
            <br>
            Upon receiving your request, we will respond without undue delay, but in all cases, within forty-five (45) days
            ...
            If you wish to appeal our decision, please email us at abrupt.game@gmail.com. Within sixty (60) days of receipt
            of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal,
            including a written explanation of the reasons for the decisions. If your appeal if denied, you may contact the
            Attorney General to submit a complaint.<br>
        </p>
        ...
        <p>
            If you have questions or comments about this notice, you may email us at abrupt.game@gmail.com.<br>
        </p>
        ...
        <p>
            ...
            your personal information, please visit: <a
                href="unsubscribe" target="_blank">www.abruptgames.fr/unsubscribe</a>.<br>
        </p>
    </div>
</template>
<style scoped>
